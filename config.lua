...
Config.Locale = 'de' -- Change to your preferred Language (de, en, nl, tr)
...
Config.MaxVehicleDistance = 10.0 -- How far can a Vehicle be away from the Flatbed to still be loaded onto it (dont make it to high or it wont be anywhere near reality!)
...
Config.Flatbeds= { -- The Vehicle (spawn-names) of your Flatbed-Vehicles / cars which can load other Vehicles on them.  X, Y, Z - Where should the Vehicle be attached to the Tow-Truck? x = left/right, y = forwards/backwards, z = up/down
    ['flatbed'] = {x = 0.0, y = -1.5, z = 1.25} -- default GTA V flatbed
}
